...
//
//   Drupal.media.browser.plugin.media_ustream = function(mediaBrowser, options) {
//     return {
//       init: function() {
//         tabset = mediaBrowser.getTabset();
//         tabset.tabs('add', '#media_ustream', 'UStream');
//         mediaBrowser.listen('tabs.show', function (e, id) {
//           if (id == 'media_ustream') {
//             // We only need to set this once.
//             // We probably could set it upon load.
//             if (mediaBrowser.getActivePanel().html() == '') {
//               mediaBrowser.getActivePanel().html(options.media_ustream);
//             }
//           }
//         });
//       }
...
//   //@todo: needs a review.
//   Drupal.media.browser.register('media_ustream', Drupal.media.browser.plugin.media_ustream, {});
// })(jQuery);
